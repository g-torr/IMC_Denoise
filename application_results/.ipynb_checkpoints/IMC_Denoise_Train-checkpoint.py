...
def generate_patches(channel_name,Raw_directory,Save_directory,n_neighbours,n_iter ):
    ...
    DataGenerator = DeepSNiF_DataGenerator(channel_name = channel_name, n_neighbours = n_neighbours, n_iter = n_iter,window_size = 5)
...
def main():
    ...
    generate_patches(channel_name,Raw_directory=Raw_directory,Save_directory=Save_directory,n_neighbours=n_neighbours,n_iter = n_iter )
